'''
This script is a reimplementation of Montgomery multiplication used for C 
algorithm debuging.
'''
...
def big_build(l):
	'''
	Build a bigint from digits list
	'''
	n = 0
...
print "Montgomery multiplication (Python)" + hex(a) + "\n\n"
print "Excepted result (C)" + hex(expected) + "\n\n"
print "Excepted result (Python)" + hex(expected2) + "\n\n"
